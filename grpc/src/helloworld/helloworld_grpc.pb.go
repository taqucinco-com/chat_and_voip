...
func (c *greeterClient) SayHelloAgain(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (Greeter_SayHelloAgainClient, error) {
	stream, err := c.cc.NewStream(ctx, &Greeter_ServiceDesc.Streams[0], "/greeter.Greeter/SayHelloAgain", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *greeterClient) SayHelloToMany(ctx context.Context, opts ...grpc.CallOption) (Greeter_SayHelloToManyClient, error) {
	stream, err := c.cc.NewStream(ctx, &Greeter_ServiceDesc.Streams[1], "/greeter.Greeter/SayHelloToMany", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *greeterClient) SayChat(ctx context.Context, opts ...grpc.CallOption) (Greeter_SayChatClient, error) {
	stream, err := c.cc.NewStream(ctx, &Greeter_ServiceDesc.Streams[2], "/greeter.Greeter/SayChat", opts...)
	if err != nil {
		return nil, err
	}
